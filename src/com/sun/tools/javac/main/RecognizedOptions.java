...
public class RecognizedOptions {
    ...
    static Set<OptionName> defaultFileManagerOptions = EnumSet.of(
        CLASSPATH,
        CP,
        SOURCEPATH,
        BOOTCLASSPATH,
    ...
    public static Option[] getDefaultFileManagerOptions(OptionHelper helper) {
        return getOptions(helper, defaultFileManagerOptions);
    }
