...
public class Main {
    ...
    public int compile(String[] args) {
        ...
        DefaultFileManager.preRegister(context); // can't create it until Log has been set up
        int result = compile(args, context);
        if (fileManager instanceof DefaultFileManager) {
            // A fresh context was created above, so jfm must be a DefaultFileManager
            ((DefaultFileManager)fileManager).close();
        }
        return result;
    }
                       ...
                       Iterable<? extends Processor> processors)
    {
        ...
        try {
            ...
            if (!filenames.isEmpty()) {
                ...
                DefaultFileManager dfm = (DefaultFileManager)fileManager;
