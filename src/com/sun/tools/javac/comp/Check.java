 ...
 **************************************************************************/
    ...
    boolean checkUnique(DiagnosticPosition pos, Symbol sym, Scope s) {
        ...
        for (Scope.Entry e = s.lookup(sym.name); e.scope == s; e = e.next()) {
            if (sym != e.sym &&
                ...
                (sym.kind != MTH || shouldReportMethodClash(sym.type, e.sym.type))) {
    ...
    //where
        private boolean shouldReportMethodClash(Type mt1, Type mt2) {
                return types.isSameType(types.erasure(mt1), types.erasure(mt2)) ||
