...
public class JCDiagnostic implements Diagnostic<JavaFileObject> {
	 ...
	 *  @see MandatoryWarningHandler
	 */
	public JCDiagnostic mandatoryNote(String key, Object... args) {
	    return new JCDiagnostic(messages, NOTE, true, null, null, qualify(NOTE, key), args);
	}
	...
	JavaFileObject s = getSource();
        return s == null ? null : DefaultFileManager.getJavacFileName(s);
    }
    ...
    /**
     * Get the basic text of this diagnostic. This is based upon the key and the
     * arguments, but does not include the source name or position.
     * @return the basic text of this diagnostic
     */
	...
	for (int i = 0; i < strings.length; i++) {
		...
		strings[i] = ((JCDiagnostic) arg).getText();
	    else
