...
public class MandatoryWarningHandler {
	...
	if (deferredDiagnosticKind != null) {
		...
		logMandatoryNote(deferredDiagnosticKind.getKey(prefix));
	    else
		logMandatoryNote(deferredDiagnosticKind.getKey(prefix), deferredDiagnosticArg);

	    if (!verbose)
		logMandatoryNote(prefix + ".recompile");
	}
    }
     ...
     */
    private void logMandatoryNote(String msg, Object... args) {
	if (enforceMandatory)
	    log.mandatoryNote(msg, args);
	else
	    log.note(msg, args);
    }
}
